...
def get_words_from_sentence(sentence):
    ### DO THIS IN CLASS
    ### To remove the punctuation you could pre-made function but we take hard way
    ### Learn esc chr
    punctuation = [".", ",", "\"", "'", ":", ";", "!", "?", "$", "@", "%", "#"]
    pass
...
# Write a function that implements the split function
def my_split(str1, delimeter):
    ### DO THIS IS IN CLASS
    pass
